...
public abstract class WizardDisplayer {
     ...
     */ 
    public static WizardDisplayer installInContainer (Container c, Object layoutConstraint, 
            Wizard awizard,
            Action helpAction, Map initialProperties, 
            WizardResultReceiver receiver, InstructionsPanel instructionsPanel, ArrayList<JButton> customButtons) {
    	WizardDisplayer displayer = getDefault(); 
    	displayer.install (c, layoutConstraint, awizard, helpAction, 
                initialProperties, receiver, instructionsPanel, customButtons);
    	return displayer;
    }
