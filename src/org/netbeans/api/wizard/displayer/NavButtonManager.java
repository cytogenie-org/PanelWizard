...
public class NavButtonManager implements ActionListener
{
    ...
    public void setCustomButtons(ArrayList<JButton> customButtons) {
        ...
        buttons = new JPanel()
        {
            public void doLayout()
            {
                ...
                if (customButtons != null) {
                	for (JButton b1: customButtons) {
                   	 b = b1;
                        n = b.getPreferredSize();
                        x -= n.width + (gap * 2);
                        b.setBounds(10, y, n.width, n.height);
                   }
                }
                                                   ...
                                                   final JButton next, final JButton finish)
    {
        ...
        final String currentStep = wizard.getCurrentStep();
        ...
        final boolean enableFinish = (canFinish || (wizard.getNextStep() != null && wizard.getNextStep().equals("PAGE7"))) && problem == null && !isDeferredResult;
        final boolean enableNext = !enableFinish && (nextStep != null || currentStep.equals("PAGE5")) && canContinue && !isDeferredResult;// problem == null &&
